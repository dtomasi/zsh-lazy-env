...
test_start "lazy_command_pattern registers pattern"
	test_setup
	lazy_var "TEST_VAR_1" "echo 'test-value-1'"
	lazy_command_pattern "^git push.*github" "TEST_VAR_1"
...
test_start "lazy_directory_pattern registers pattern"
	test_setup
	lazy_var "TEST_VAR_1" "echo 'test-value-1'"
	lazy_directory_pattern ".*/terraform/.*" "TEST_VAR_1"
